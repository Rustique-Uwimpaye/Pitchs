...
def index():
    ...
    pitch=Pitches.query.filter_by(categ="RI").all()
    pitch1=Pitches.query.filter_by(categ="ST").all()
    pitch2=Pitches.query.filter_by(categ="DMD").all()
    pitch3=Pitches.query.filter_by(categ="GEW").all()
    top.reverse()
    top_pitch=top[0:4]
